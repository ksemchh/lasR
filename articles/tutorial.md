...
#> source      : file287f25c9b6fe.tif 
#> name        : file287f25c9b6fe
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/RtmpS7k94j/bcts_1_ground.laz /tmp/RtmpS7k94j/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/RtmpS7k94j/bcts_1_normalized.laz /tmp/RtmpS7k94j/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/RtmpS7k94j/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. :  
#> source      : file287f6ac7e1a2.tif 
#> name        : file287f6ac7e1a2
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
