...
#> source      : file280c4386c31.tif
#> name        : file280c4386c31
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/Rtmp41e9wv/bcts_1_ground.laz /tmp/Rtmp41e9wv/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/Rtmp41e9wv/bcts_1_normalized.laz /tmp/Rtmp41e9wv/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/Rtmp41e9wv/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. : 
#> source      : file280c1519e0f9.tif
#> name        : file280c1519e0f9
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
