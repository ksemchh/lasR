...
#> source      : file29124ac4552b.tif 
#> name        : file29124ac4552b
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/RtmpZjGGbQ/bcts_1_ground.laz /tmp/RtmpZjGGbQ/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/RtmpZjGGbQ/bcts_1_normalized.laz /tmp/RtmpZjGGbQ/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/RtmpZjGGbQ/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. :  
#> source      : file2912e3fe402.tif 
#> name        : file2912e3fe402
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
