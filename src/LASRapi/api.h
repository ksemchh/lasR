...
Pipeline reader_coverage(std::vector<std::string> filter = {""}, std::string select = "*", int depth = -1, std::string aoi = "");
Pipeline reader_circles(std::vector<double> xc, std::vector<double> yc, std::vector<double> r, std::vector<std::string> filter = {""}, std::string select = "*", int depth = -1, std::string aoi = "");
Pipeline reader_rectangles(std::vector<double> xmin, std::vector<double> ymin, std::vector<double> xmax, std::vector<double> ymax, std::vector<std::string> filter = {""}, std::string select = "*", int depth = -1, std::string aoi = "");
